...
ans_1 = "correct" if qns_1.lower() == "computer science" else "incorrect"
print(ans_1)


# question 2
qns_2 = input("CPU full form :")
ans_2 = "correct" if qns_2.lower() == "central processing unit" else "incorrect"
print(ans_2)


# question 3
qns_3 = input("GPU full form :")
ans_3 = "correct" if qns_3.lower() == "graphics processing unit" else "incorrect"
print(ans_3)
